...
[[ -f "$workdir/../AGENTS.md" ]] && prompt+="The job ran from a job-scripts folder; the project root is $(dirname "$workdir") and its AGENTS.md explains the layout. Take bundle and record paths from the job script and output. "
